...
public class KubernetesApi extends AIEngineAdapter {
    ...
    public KubernetesApi(Map<String, Object> config, String jobName) throws BadConfigurationException {
    ...
    @Override
    public void mergeModels() throws AIEngineException {
        String[] command = new String[]{"/bin/sh", "-c", "cd /usr/application && bash merging_models.sh"};
